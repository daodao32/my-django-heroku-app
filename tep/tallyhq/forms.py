...
class TeacherLoginForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if num_records == 0:
            message = format_html('<div class="header">You are not a registered user</div><p>The first name, last name, email and school combination does not match a registered user. &nbsp; &nbsp; Note that fields are case sensitive.<br>'
